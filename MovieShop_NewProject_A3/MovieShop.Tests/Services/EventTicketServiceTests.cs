...
namespace MovieShop.Tests.Services
{
    public class EventTicketServiceTests
    {
        ...
        {
            // Act
            var result = service.CanBuyTicket(0, new MovieEvent { TicketPrice = 10 });
        ...
        {
            // Act
            var result = service.CanBuyTicket(1, null);
        ...
        {
            // Arrange
            mockUserRepo.Setup(r => r.GetBalance(1)).Returns(50m);

            // Act
            var result = service.CanBuyTicket(1, new MovieEvent { TicketPrice = 20m });
        ...
        public void PurchaseTicket_ValidPurchase_CallsRepositoryAndUpdatesSession()
        {
            ...
            mockUserRepo.Setup(r => r.GetBalance(1)).Returns(30m);

            // Act
            service.PurchaseTicket(1, movieEvent);

            // Assert
            mockEventRepo.Verify(r => r.PurchaseTicket(1, 1), Times.Once);
